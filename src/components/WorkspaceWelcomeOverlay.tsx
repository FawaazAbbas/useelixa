  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
        {/* Logo/Icon */}
        <div
          className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 shadow-2xl shadow-violet-500/30 mb-8 transition-all duration-700 ${
