...
export const ShopifyDeepDiveSlide = () => {
  return (
    <SlideShell background="custom">
      ...
      >
        5.5 million customers who spend $120 monthly on apps. <span className="font-semibold text-slate-900">64% are small businesses</span>—exactly our target market.
      </motion.p>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <p className="text-base text-slate-700 leading-relaxed">
                ...
                use fragmented tools, and are actively seeking automation. They spend{" "}
                <span className="font-semibold text-green-700">$120/month on productivity tools</span> and understand that{" "}
                <span className="font-semibold text-slate-900">time saved equals money earned</span>.
              </p>
            </div>
          </div>
        </div>
