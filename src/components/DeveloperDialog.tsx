  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="sm:max-w-[600px] max-h-[90vh] p-0 overflow-hidden border border-border bg-background shadow-2xl rounded-2xl"
      >
        {!submitted ? (
          <div className="relative overflow-hidden">
            ...
            <div className="p-8 overflow-y-auto max-h-[85vh]">
              ...
              <div className="text-center space-y-3 mb-8">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-foreground">Build with Elixa</h2>
