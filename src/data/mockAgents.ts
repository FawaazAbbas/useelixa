...
export const mockAgents: MockAgent[] = [
  ...
  },
  {
    ...
    badge: "AI-Powered",
    capabilities: [
      "Real-Time Dynamic Pricing Across Entire Catalog",
      "Autonomous Competitor Price Scanning (BackMarket, CeX, Amazon Renewed, More)",
      "Full Catalog Creation, Cleanup & SEO Optimization",
      "SKU-Level Profitability Modeling (True Margin)",
      "End-to-End Inventory Forecasting & Demand Prediction",
      "Return-Prevention & Quality Issue Detection",
      "Automatic Product Description Generation & Upgrade",
      "Liquidation Strategy + Slow-Mover Recovery",
      "High-Accuracy Sales Velocity Tracking",
      "Autonomous Bundle Creation & AOV Optimisation",
      "Grade Consistency & Battery Health Assurance",
      "Margin-Protective Discounting Engine",
      "Cross-Department Strategy Collaboration (Marketing, CX, Ops)",
      "Seasonal Trend Detection & Category Expansion Intelligence",
      "Competitor Undercut/Avoid Logic With Self-Adjusting Price Bands",
      "Product Launch Architect (Pages, Pricing, Variants, SEO)",
      "Customer Intent & Behaviour Insights",
      "Autonomous Collection and Merchandising Optimisation",
      "Multi-Supplier Quotations & Cost Analysis",
      "True End-to-End Product Lifecycle Intelligence",
    ],
