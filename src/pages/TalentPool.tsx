...
const TalentPool = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
      ...
      <div className={`fixed top-0 left-0 right-0 z-40 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${isFiltering ? 'translate-y-[72px] opacity-100 scale-100 delay-300' : 'translate-y-0 opacity-0 scale-95 pointer-events-none delay-0'}`}>
