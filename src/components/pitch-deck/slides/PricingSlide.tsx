        ...
        {plans.map((plan, index) => (
          <motion.div
            ...
            className={`pitch-card p-4 md:p-6 ${
              plan.highlight
                ? 'bg-gradient-to-br from-primary/10 to-purple-100 border-2 border-primary relative'
                : ''
            }`}
          >
            {plan.highlight && (
      ...
      >
        <div className="pitch-card bg-green-50 border-l-4 border-green-500 flex gap-4">
          ...
          <p className="text-sm text-slate-700">
            <span className="font-semibold text-slate-900">Why these prices?</span> The average SME employee costs £39,039/year. 
            Our Pro plan gives you 6 AI employees for £180/year—that's{" "}
