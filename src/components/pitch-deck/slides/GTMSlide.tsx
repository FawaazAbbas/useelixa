...
const strategies = [
  { icon: Users, title: "Social Media", description: "LinkedIn, Twitter early adopters", color: "text-blue-600", bgColor: "bg-blue-100" },
  { icon: Mail, title: "Waitlist", description: "Targeted outreach & referrals", color: "text-purple-600", bgColor: "bg-purple-100" },
  { icon: MessageCircle, title: "Community", description: "Reddit, Indie Hackers, PH", color: "text-green-600", bgColor: "bg-green-100" },
  { icon: Target, title: "Paid Ads", description: "17p cost-per-lead", color: "text-red-600", bgColor: "bg-red-100" },
  { icon: FileText, title: "Content", description: "SEO-driven guides", color: "text-orange-600", bgColor: "bg-orange-100" },
  { icon: Handshake, title: "Partnerships", description: "SME service providers", color: "text-teal-600", bgColor: "bg-teal-100" },
  { icon: Gift, title: "Promotions", description: "Giveaways & influencers", color: "text-pink-600", bgColor: "bg-pink-100" },
  { icon: Smartphone, title: "Native Apps", description: "Shopify, WooCommerce, mobile", color: "text-indigo-600", bgColor: "bg-indigo-100" },
];
