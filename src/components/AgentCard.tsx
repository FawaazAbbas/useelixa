...
export const AgentCard = ({ agent }: AgentCardProps) => {
  ...
  return (
    <div 
      ...
      onClick={handleClick}
    >
      <div className={`relative h-full rounded-xl overflow-hidden transition-all duration-300 group-hover:-translate-y-2 border ${config.tint} ${config.glow} ${config.border}`}>
        {/* Accent line at top */}
