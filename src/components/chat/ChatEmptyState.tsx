  ...
  const suggestions = [
    {
      ...
      title: "What tools can you help me connect?",
    },
    {
      icon: <Search className="h-5 w-5" />,
      title: "Search my connected services for data",
    },
    {
      icon: <Zap className="h-5 w-5" />,
      title: "Help me automate a workflow",
    },
  ];
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8">
      ...
      <p className="text-muted-foreground text-center max-w-md mb-8">
        I'm Elixa, your AI assistant. I can help you connect tools, 
        search your data, and automate your workflows.
      </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                ...
                send emails, search your files, post messages, and much more.
              </p>
              <Button 
                size="sm" 
